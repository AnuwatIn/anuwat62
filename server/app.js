...
var privateKey  = fs.readFileSync('/etc/letsencrypt/live/lookago.ddns.net/privkey.pem', 'utf8');
var certificate = fs.readFileSync('/etc/letsencrypt/live/lookago.ddns.net/fullchain.pem', 'utf8');
